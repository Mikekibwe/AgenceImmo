...
@section('content')
    ...
    <div class="bg-light p-5 mb-5 text-center">
        <form action="" method="get" class="container d-flex gap-2">
            ...
            <input type="number" name="rooms" class="form-control" placeholder="Nombre de pièce min" value="{{ $input['rooms'] ?? '' }}">
            <input type="number" name="price" class="form-control" placeholder="Budget max" value="{{ $input['price'] ?? '' }}">
            <input name="title" class="form-control" placeholder="Mot clef" value="{{ $input['title'] ?? '' }}">
